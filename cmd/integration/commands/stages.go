...
var cmdResetOtsBlocksRewarded = &cobra.Command{
	Use:   "reset_ots_blocks_rewarded",
	Short: "",
	Run:   runResetStage(stages.OtsBlocksRewarded, "", nil),
}
...
var cmdUnwindOtsBlocksRewarded = &cobra.Command{
	Use:   "unwind_ots_blocks_rewarded",
	Short: "",
	Run: runUnwindLogStage(
		stages.OtsBlocksRewarded,
		stagedsync.NewGenericBlockIndexerUnwinder(kv.OtsBlocksRewardedIndex, kv.OtsBlocksRewardedCounter, stagedsync.RunBlocksRewardedBlockUnwind),
	),
}
...
var cmdUnwindOtsWithdrawals = &cobra.Command{
	...
	Run: runUnwindLogStage(
		...
		stagedsync.NewGenericBlockIndexerUnwinder(kv.OtsWithdrawalsIndex, kv.OtsWithdrawalsCounter, stagedsync.RunWithdrawalsBlockUnwind),
	),
}
...
func init() {
	...
	withDataDir(cmdResetOtsBlocksRewarded)
	rootCmd.AddCommand(cmdResetOtsBlocksRewarded)
	...
	withDataDir(cmdUnwindOtsBlocksRewarded)
	withChain(cmdUnwindOtsBlocksRewarded)
	withUnwind(cmdUnwindOtsBlocksRewarded)
	rootCmd.AddCommand(cmdUnwindOtsBlocksRewarded)
